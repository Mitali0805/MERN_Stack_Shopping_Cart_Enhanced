...
exports.listRelated = (req,res) => {
    ...
    Product.find({_id: {$ne: req.product}, category: req.product.category})         //show all related product not including that product
    .limit(limit)
...
//get only those categories related to products
